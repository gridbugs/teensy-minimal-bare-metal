...
static inline void attachInterruptVector(IRQ_NUMBER_t irq, void (*function)(void))
{
...
static inline void attachInterruptVector(enum IRQ_NUMBER_t irq, void (*function)(void))
{
    _VectorsRam[irq + 16] = function;
    asm volatile(""
                 :
